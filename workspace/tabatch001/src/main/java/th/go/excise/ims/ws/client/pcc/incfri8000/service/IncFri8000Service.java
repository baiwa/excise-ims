...
@Service
public class IncFri8000Service extends AbstractPccRestfulService<RequestData, ResponseData> {

	@Autowired
	public IncFri8000Service(
			@Value("${ws.excise.inc.incfri8000.endpoint}") String url,
