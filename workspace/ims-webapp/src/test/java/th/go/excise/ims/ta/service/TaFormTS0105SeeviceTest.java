...
public class TaFormTS0105SeeviceTest {
	...
	public void test_generateReport() throws Exception {
		...
		formTS0105Vo.setOfficeName("ตรวจสอบภาษี");
		...
		formTS0105Vo.setRefDocSend("กรมสรรพสามิต");
		...
		formTS0105Vo.setDestText("กรมสรรพสามิต");
		...
		formTS0105Vo.setSignOfficerPosition("ตรวจสอบภายใน");
