...
public class TaFormTS0106ServiceTest {
	...
	public void test_generateReport() throws Exception {
		...
		formTS0106Vo.setWriterFullName("");
		formTS0106Vo.setWriterPositionFlag("");
		formTS0106Vo.setFactoryName("");
		formTS0106Vo.setNewRegId("");
		formTS0106Vo.setFacAddrNo("");
		formTS0106Vo.setFacMooNo("");
		formTS0106Vo.setFacSoiName("");
		formTS0106Vo.setFacThnName("");
		formTS0106Vo.setFacTambolName("");
		formTS0106Vo.setFacAmphurName("");
		formTS0106Vo.setFacProvinceName("");
		formTS0106Vo.setFacZipCode("");
