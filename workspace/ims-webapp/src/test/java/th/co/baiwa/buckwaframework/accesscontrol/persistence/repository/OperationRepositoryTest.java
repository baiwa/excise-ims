...
public class OperationRepositoryTest {
	...
	public void test_findOne_Found() {
		...
		Operation operation = operationRepository.findOne(1L);
	...
	public void test_findOne_NotFound() {
		...
		Operation operation = operationRepository.findOne(99L);
		System.out.println(operation);
	...
	public void test_save_update() {
		...
		Operation operation = operationRepository.findOne(3L);
