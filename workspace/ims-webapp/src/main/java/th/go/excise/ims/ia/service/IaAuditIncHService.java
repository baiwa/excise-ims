...
public class IaAuditIncHService {
	...
	public IaAuditIncH createIaAuditIncH(Int0601Vo vo) {
		logger.info("insert IaAuditIncH");
		IaAuditIncH iaAuditIncH = iaAuditIncHRepository.save(vo.getIaAuditIncH());
		if(iaAuditIncH.getIaAuditIncHId() != null) {
			logger.info("insert IaAuditIncH Completed "); 
			if(vo.getIaAuditIncD1List() != null && vo.getIaAuditIncD1List().size() > 0) {
				logger.info("insert Drtail1 "); 
