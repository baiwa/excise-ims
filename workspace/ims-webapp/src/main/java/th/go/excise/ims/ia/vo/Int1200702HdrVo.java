...
public class Int1200702HdrVo {
	...
	private String treatedDateFrom;
	private String treatedDateTo;
	...
	private String siblingsOrder2;
	private String siblingsOrder3;
	...
	public void setSiblingsOrder(String siblingsOrder) {
	...
	public void setChild1(boolean child1) {
		this.child1 = child1;
	}
	...
	public boolean isChild3() {
		return child3;
	}

	public void setChild3(boolean child3) {
		this.child3 = child3;
	}
	...
	public String getTreatedDateFrom() {
		return treatedDateFrom;
	}

	public void setTreatedDateFrom(String treatedDateFrom) {
		this.treatedDateFrom = treatedDateFrom;
	}

	public String getTreatedDateTo() {
		return treatedDateTo;
	}

	public void setTreatedDateTo(String treatedDateTo) {
	...
	public String getIaDisReqId() {
		return iaDisReqId;
	}

	public void setIaDisReqId(String iaDisReqId) {
	...
	public String getSiblingsOrder2() {
		return siblingsOrder2;
	}

	public void setSiblingsOrder2(String siblingsOrder2) {
		this.siblingsOrder2 = siblingsOrder2;
	}

	public String getSiblingsOrder3() {
		return siblingsOrder3;
	}

	public void setSiblingsOrder3(String siblingsOrder3) {
		this.siblingsOrder3 = siblingsOrder3;
	}

	public List<Int120702DtlVo> getReceipts() {
		return receipts;
	}

	public void setReceipts(List<Int120702DtlVo> receipts) {
