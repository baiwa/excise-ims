...
import th.go.excise.ims.oa.persistence.repository.jdbc.Oa0401JdbcRepository;
...
public class Oa0401Service {
	...
	@Autowired
	private Oa0401JdbcRepository oa0401JdbcRepo;
...
//			license.setOaLicensePlanId(request.getListCompany().get(i).getOaCuslicenseId());
	...
	public Oa0201FromVo findOaplanACH(String  planId,String officeCode) {
		...
		if (planOpt.isPresent()) {
			...
			List<Oa0201001Vo> listLicense = oa0401JdbcRepo.findLicenseACHPlanId(id);
