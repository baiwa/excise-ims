...
@Entity
@Table(name = "IA_EXAMINATION_PLAN")
public class IaExaminationPlan
    extends BaseEntity
{

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IA_EXAMINATION_PLAN_GEN")
    @SequenceGenerator(name = "IA_EXAMINATION_PLAN_GEN", sequenceName = "IA_EXAMINATION_PLAN_SEQ", allocationSize = 1)
    @Column(name = "ID")
