...
public class Int0602SaveVo {
	...
	public void setAuditLicH(AuditLicHVo auditLicH) {
		this.auditLicH = auditLicH;
	}

	public List<AuditLicD1Vo> getAuditLicD1List() {
		return auditLicD1List;
	}
