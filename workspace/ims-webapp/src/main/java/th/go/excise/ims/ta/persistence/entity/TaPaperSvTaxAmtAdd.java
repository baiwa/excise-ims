...
public class TaPaperSvTaxAmtAdd
    extends BaseEntity
{
    ...
    private BigDecimal paperSvTaxAmtAddId;
    ...
    public BigDecimal getPaperSvTaxAmtAddId() {
        return paperSvTaxAmtAddId;
    }

    public void setPaperSvTaxAmtAddId(BigDecimal paperSvTaxAmtAddId) {
