...
public class TaFormTSController {
    ...
    @Autowired
    public TaFormTSController(TaFormTS0110Service formTS0110Service, TaFormTS0107Service formTS0107Service, TaFormTS0113Service taFormTS0113Service) {
...
//		IOUtils.write(reportFile, response.getOutputStream());
    ...
    public void pdfTs0113(@ModelAttribute ReportJsonBean reportJsonBean, HttpServletResponse response)
            throws Exception {
