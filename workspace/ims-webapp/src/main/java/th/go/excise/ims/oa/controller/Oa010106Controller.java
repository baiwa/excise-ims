...
public class Oa010106Controller {
	...
	@ResponseBody
	public ResponseData<OaHydCustomer> findById(@PathVariable("id") String idStr) {
		ResponseData<OaHydCustomer> responseData = new ResponseData<>();
		OaHydCustomer data = new OaHydCustomer();
		try {
