...
@Controller
@RequestMapping("/api/oa/07/01")
public class Oa0701Controller {

	private static final Logger logger = LoggerFactory.getLogger(Oa0701Controller.class);
	...
	@PostMapping("/reg4000")
	@ResponseBody
	public ResponseData<ResponseOa07Vo> reg4000(@RequestBody Oa07FormVo formVo) {
		ResponseData<ResponseOa07Vo> response = new ResponseData<>();
		try {
			ResponseOa07Vo data = oa0701Service.reg4000(formVo);
