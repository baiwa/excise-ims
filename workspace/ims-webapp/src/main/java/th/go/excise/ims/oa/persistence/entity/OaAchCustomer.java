...
@Entity
@Table(name = "OA_ACH_CUSTOMER")
public class OaAchCustomer
    extends BaseEntity
{

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_ACH_CUSTOMER_GEN")
    @SequenceGenerator(name = "OA_ACH_CUSTOMER_GEN", sequenceName = "OA_ACH_CUSTOMER_SEQ", allocationSize = 1)
