...
@Entity
@Table(name = "OA_LICENSE_PLAN")
public class OaLicensePlan
    extends BaseEntity
{

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_LICENSE_PLAN_GEN")
    @SequenceGenerator(name = "OA_LICENSE_PLAN_GEN", sequenceName = "OA_LICENSE_PLAN_SEQ", allocationSize = 1)
