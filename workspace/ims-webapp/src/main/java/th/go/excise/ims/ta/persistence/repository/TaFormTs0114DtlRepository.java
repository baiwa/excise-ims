...
public interface TaFormTs0114DtlRepository extends CommonJpaCrudRepository<TaFormTs0114Dtl, Long>, TaFormTs0114DtlRepositoryCustom {
    ...
    TaFormTs0114Dtl findByFormTsNumberAndFormTs0114DtlId(String formTsNumber, Long formTs0114DtlId);
}
