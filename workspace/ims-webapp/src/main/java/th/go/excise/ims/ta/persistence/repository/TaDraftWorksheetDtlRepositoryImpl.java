...
public class TaDraftWorksheetDtlRepositoryImpl implements TaDraftWorksheetDtlCustom {
	...
	public void saveBatchDraft(List<TaDraftWorksheetDtl> listDraft) throws SQLException {
		String sql = SqlGeneratorUtils.genSqlInsert("TA_DRAFT_WORKSHEET_DTL", Arrays.asList("ID", "DRAFT_NUMBER", "NEW_REG_ID", "SUM_TAX_AMT_G1", "SUM_TAX_AMT_G2", "TAX_AMT_CHN_PNT", "TAX_MONTH_NO", "TAX_AMT_G1_M1", "TAX_AMT_G1_M2", "TAX_AMT_G1_M3", "TAX_AMT_G1_M4", "TAX_AMT_G1_M5",
