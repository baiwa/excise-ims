...
public class IaAuditIncSendD extends BaseEntity {
	...
	public String getIncsendEdcLicense() {
		return incsendEdcLicense;
	}

	public void setIncsendEdcLicense(String incsendEdcLicense) {
	...
	public BigDecimal getIncsendAccPayIn() {
		return incsendAccPayIn;
	}

	public void setIncsendAccPayIn(BigDecimal incsendAccPayIn) {
