...
@Entity
@Table(name = "IA_RISK_FACTORS_MAS_CON")
public class IaRiskFactorsMasCon
    extends BaseEntity
{

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IA_RISK_FACTORS_MAS_CON_GEN")
    @SequenceGenerator(name = "IA_RISK_FACTORS_MAS_CON_GEN", sequenceName = "IA_RISK_FACTORS_MAS_CON_SEQ", allocationSize = 1)
    @Column(name = "ID")
