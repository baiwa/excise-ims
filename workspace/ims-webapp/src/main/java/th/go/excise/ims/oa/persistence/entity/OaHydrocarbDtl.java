...
@Entity
@Table(name = "OA_HYDROCARB_DTL")
public class OaHydrocarbDtl
    extends BaseEntity
{

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_HYDROCARB_DTL_GEN")
    @SequenceGenerator(name = "OA_HYDROCARB_DTL_GEN", sequenceName = "OA_HYDROCARB_DTL_SEQ", allocationSize = 1)
    @Column(name = "OA_HYDROCARB_DTL_ID")
