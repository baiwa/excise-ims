...
public class Oa010106DtlVo {
	...
	public List<OaHydrocarbCust> getCustomers() {
		return customers;
	}

	public void setCustomers(List<OaHydrocarbCust> customers) {
		this.customers = customers;
	}

	public List<OaHydrocarbCust> getCustdeles() {
		return custdeles;
	}

	public void setCustdeles(List<OaHydrocarbCust> custdeles) {
