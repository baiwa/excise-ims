...
public class TaPaperSvBalGoods
    extends BaseEntity
{
    ...
    private BigDecimal paperSvBalGoodsId;
    ...
    public BigDecimal getPaperSvBalGoodsId() {
        return paperSvBalGoodsId;
    }

    public void setPaperSvBalGoodsId(BigDecimal paperSvBalGoodsId) {
