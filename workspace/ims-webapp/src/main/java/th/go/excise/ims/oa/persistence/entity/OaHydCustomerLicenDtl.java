...
@Entity
@Table(name = "OA_HYD_CUSTOMER_LICEN_DTL")
public class OaHydCustomerLicenDtl
    extends BaseEntity
{

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_HYD_CUSTOMER_LICEN_DTL_GEN")
    @SequenceGenerator(name = "OA_HYD_CUSTOMER_LICEN_DTL_GEN", sequenceName = "OA_HYD_CUSTOMER_LICEN_DTL_SEQ", allocationSize = 1)
