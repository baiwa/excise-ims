    ...
    extends BaseEntity
{
    ...
    private BigDecimal paperSvMemberId;
    ...
    public BigDecimal getPaperSvMemberId() {
        return paperSvMemberId;
    }

    public void setPaperSvMemberId(BigDecimal paperSvMemberId) {
