...
@Service
public class InquiryHolidayService extends AbstractPccRestfulService<Holiday, List<Holiday>> {
	...
	@Override
	public List<Holiday> execute(Holiday requestData) throws PccRestfulException {
