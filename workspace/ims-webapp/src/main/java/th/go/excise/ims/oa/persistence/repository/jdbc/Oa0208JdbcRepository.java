...
@Repository
public class Oa0208JdbcRepository {
	...
	private RowMapper<Oa0208Vo> dataRowmapper = new RowMapper<Oa0208Vo>() {
		@Override
		public Oa0208Vo mapRow(ResultSet rs, int arg1) throws SQLException {
			Oa0208Vo vo = new Oa0208Vo();
	...
	private RowMapper<Oa0208ApproveVo> dataApproveRowmapper = new RowMapper<Oa0208ApproveVo>() {
		@Override
		public Oa0208ApproveVo mapRow(ResultSet rs, int arg1) throws SQLException {
			Oa0208ApproveVo vo = new Oa0208ApproveVo();
			vo.setId(rs.getBigDecimal("OA_PLAN_ID"));
			vo.setAuditStart(rs.getDate("AUDIT_START"));
			vo.setAuditEnd(rs.getDate("AUDIT_END"));
			vo.setBudgetYear(rs.getString("FISCOL_YEAR"));
	...
	public List<Oa020801ApproveVo> findApproveList(BigDecimal planId) {
		StringBuilder sql = new StringBuilder();
		List<Object> params = new ArrayList<Object>();
		...
		sql.append(" AND LP.OA_PLAN_ID = ? ");
		params.add(planId);
		List<Oa020801ApproveVo> datas = this.commonJdbcTemplate.query(sql.toString(), params.toArray(), approveRowmapper);
		return datas;
	}

	private RowMapper<Oa020801ApproveVo> approveRowmapper = new RowMapper<Oa020801ApproveVo>() {
		@Override
		public Oa020801ApproveVo mapRow(ResultSet rs, int arg1) throws SQLException {
			Oa020801ApproveVo vo = new Oa020801ApproveVo();
	...
	public List<Oa020801CheckerVo> findChecker(BigDecimal planId) {
		StringBuilder sql = new StringBuilder();
		List<Object> params = new ArrayList<Object>();
		...
		params.add(planId);
		List<Oa020801CheckerVo> datas = this.commonJdbcTemplate.query(sql.toString(), params.toArray(), checkerRowmapper);
		return datas;
	}
	
	private RowMapper<Oa020801CheckerVo> checkerRowmapper = new RowMapper<Oa020801CheckerVo>() {
		@Override
		public Oa020801CheckerVo mapRow(ResultSet rs, int arg1) throws SQLException {
			Oa020801CheckerVo vo = new Oa020801CheckerVo();
