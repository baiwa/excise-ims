...
public class ExportRiskFromVo {
	...
	public String getCheckPositi() {
		return checkPositi;
	}

	public void setCheckPositi(String checkPositi) {
		this.checkPositi = checkPositi;
	}
