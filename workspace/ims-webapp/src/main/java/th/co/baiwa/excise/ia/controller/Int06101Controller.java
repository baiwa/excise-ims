...
public class Int06101Controller {
	...
	@GetMapping("/withdraw/list/{id}")
	@ResponseBody
	public IaWithdrawalList getListById(@PathVariable("id") Long id) {
		return int06101Service.findById(id);
	}
	
	@GetMapping("/withdraw/person/{id}")
	@ResponseBody
	public List<IaWithdrawalPersons> getPersonById(@PathVariable("id") Long id) {
		return int06101Service.findByListId(id);
	}
