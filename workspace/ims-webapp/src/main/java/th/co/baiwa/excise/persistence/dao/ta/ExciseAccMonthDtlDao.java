...
@Repository
public class ExciseAccMonthDtlDao {
	@Autowired
	private JdbcTemplate jdbcTemplate;
	
	private Logger logger = LoggerFactory.getLogger(ExciseAccMonthDtlDao.class);

	private final String sql = " SELECT * FROM TA_EXCISE_ACC_MONTH_DTL ";
