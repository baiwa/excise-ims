...
@Repository
public class Int061109Dao {

	private static Logger log = LoggerFactory.getLogger(Int061109Dao.class);
	
	@Autowired
	private JdbcTemplate jdbcTemplate;

	
	private final String SQL_IA_DISBURSEMENT_REQUEST = " SELECT * FROM IA_DISBURSEMENT_REQUEST WHERE IS_DELETED = 'N' AND REQUEST_TYPE = ? AND STATUS = '2208' ";
	  

		public List<DisbursementRequest> findAllInt061109(Int061109FormVo formVo) {
...
//			sql.append(" ORDER BY OFFICE_CODE asc");
	        ...
	        List<DisbursementRequest> list = jdbcTemplate.query(sql.toString(), params.toArray(), int061109Rowmapper);
	        return list;
	    }
		
		 private RowMapper<DisbursementRequest> int061109Rowmapper = new RowMapper<DisbursementRequest>() {
		    	@Override
			...
			public void updateBillLadingInt061109(Int061109FormVo form) {
				...
				log.info("updateBillLadingInt061109 sql : {}",sql);
		       jdbcTemplate.update(sql.toString(),new Object[] {form.getBillLading(),form.getId()});
		    }
			
			public void updateBillPayInt061109(Int061109FormVo form) {
			...
			public void updateApproveInt061109(Int061109FormVo form) {
