...
@Entity
@Table(name="OA_TAX_AUDIT_RES_WS_HDR")
public class OaTaxAuditResWsHdr extends BaseEntity {
	
	private static final long serialVersionUID = 4864923948371888944L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_TAX_AUDIT_RES_WS_HDR_GEN")
	@SequenceGenerator(name = "OA_TAX_AUDIT_RES_WS_HDR_GEN", sequenceName = "OA_TAX_AUDIT_RES_WS_HDR_SEQ", allocationSize = 1)
