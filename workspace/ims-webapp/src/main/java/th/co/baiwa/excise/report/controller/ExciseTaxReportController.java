...
public class ExciseTaxReportController {
	...
	@ResponseBody
	public void saveReport(@RequestBody TaYearPlanReport taYearPlanReport) {
		taxAuditReportService.saveTaYearPlanReport(taYearPlanReport);
	}

	@PostMapping("/dataReport")
	@ResponseBody
	public TaYearPlanReport dataReport(@RequestBody Long id) {
		return taxAuditReportService.dataReport(id);
	}
