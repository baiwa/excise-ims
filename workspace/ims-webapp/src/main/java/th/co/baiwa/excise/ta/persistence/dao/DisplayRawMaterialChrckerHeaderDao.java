...
@Repository
public class DisplayRawMaterialChrckerHeaderDao {
	@Autowired
	private JdbcTemplate jdbcTemplate;

	private final String SQL = "SELECT * FROM TA_RECEIVE_RMAT_WS_HEADER WHERE 1=1 ";
	...
	public List<Ope0411Vo> findAll(Ope0462FormVo formVo) {
		...
		List<Ope0411Vo> list = jdbcTemplate.query(listSql, params.toArray(), headerRowmapper);
		return list;

	}

	private RowMapper<Ope0411Vo> headerRowmapper = new RowMapper<Ope0411Vo>() {
		@Override
		public Ope0411Vo mapRow(ResultSet rs, int arg1) throws SQLException {
			Ope0411Vo vo = new Ope0411Vo();

			vo.setTaTaxReduceWsHdrId(rs.getString("TA_RECEIVE_RMAT_HEADER_ID"));
