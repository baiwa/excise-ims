...
public class RiskAssExcAreaHdrRepositoryImpl implements RiskAssExcAreaHdrRepositoryCustom {
	...
	public List<Int0801Vo> findProjectBaseByBudgetYear(String budgetYear) {
		...
		sql.append(" SELECT D.PROJECT_BASE , D.DEPARTMENT_NAME FROM IA_RISK_ASS_EXC_AREA_HRD H ");
		...
		sql.append(" UNION ");
		sql.append(" SELECT O.PROJECT_BASE , o.DEPARTMENT_NAME FROM IA_RISK_ASS_EXC_AREA_HRD H ");
