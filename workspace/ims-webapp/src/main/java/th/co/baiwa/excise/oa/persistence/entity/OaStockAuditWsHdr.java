...
@Entity
@Table(name="OA_STOCK_AUDIT_WS_HDR")
public class OaStockAuditWsHdr extends BaseEntity {

	private static final long serialVersionUID = 2475858122852901079L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_STOCK_AUDIT_WS_HDR_GEN")
	@SequenceGenerator(name = "OA_STOCK_AUDIT_WS_HDR_GEN", sequenceName = "OA_STOCK_AUDIT_WS_HDR_SEQ", allocationSize = 1)
