...
@Entity
@Table(name="IA_RISK_ASS_EXC_NOC_DTL")
public class RiskAssExcNocDtl extends BaseEntity{

	private static final long serialVersionUID = -7112366338796807793L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IIA_RISK_ASS_EXC_NOC_DTL_GEN")
	@SequenceGenerator(name = "IIA_RISK_ASS_EXC_NOC_DTL_GEN", sequenceName = "IIA_RISK_ASS_EXC_NOC_DTL_SEQ", allocationSize = 1)
