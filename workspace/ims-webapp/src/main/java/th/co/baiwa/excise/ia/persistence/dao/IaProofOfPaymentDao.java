...
@Repository
public class IaProofOfPaymentDao {
	...
	public Long count(Int09221FormVo formVo) {
	...
	public List<Int09221Vo> findAll(Int09221FormVo formVo) {
        ...
        List<Int09221Vo> list = jdbcTemplate.query(sql.toString(), params.toArray(), budgetRowmapper);
        return list;
    }
	
	 private RowMapper<Int09221Vo> budgetRowmapper = new RowMapper<Int09221Vo>() {
	    	@Override
	    	public Int09221Vo mapRow(ResultSet rs, int arg1) throws SQLException {
	    		Int09221Vo vo = new Int09221Vo();
