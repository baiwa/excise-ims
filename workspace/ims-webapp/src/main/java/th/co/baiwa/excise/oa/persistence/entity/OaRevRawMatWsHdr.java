...
@Entity
@Table(name="OA_REV_RAW_MAT_WS_HDR")
public class OaRevRawMatWsHdr extends BaseEntity{

	private static final long serialVersionUID = -9033423870739411405L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_REV_RAW_MAT_WS_HDR_GEN")
	@SequenceGenerator(name = "OA_REV_RAW_MAT_WS_HDR_GEN", sequenceName = "OA_REV_RAW_MAT_WS_HDR_SEQ", allocationSize = 1)
