...
@Entity
@Table(name="OA_PRICE_AUDIT_WS_HDR")

public class OaPriceAuditWsHdr extends BaseEntity  {
	
	private static final long serialVersionUID = -628656859373856855L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_PRICE_AUDIT_WS_HDR_GEN")
	@SequenceGenerator(name = "OA_PRICE_AUDIT_WS_HDR_GEN", sequenceName = "OA_PRICE_AUDIT_WS_HDR_SEQ", allocationSize = 1)
	...
	public BigDecimal getOperPlanId() {
		return operPlanId;
	}

	public void setOperPlanId(BigDecimal operPlanId) {
