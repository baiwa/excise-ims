...
@Repository
public class DisplayCreatePeperChrckerHeaderDao {
	@Autowired
	private JdbcTemplate jdbcTemplate;

	private final String SQL = "SELECT * FROM TA_TAX_REDUCE_WS_HDR WHERE 1=1 ";
	...
	public List<Ope0462Vo> findAll(Ope0462FormVo formVo) {
	...
	private RowMapper<Ope0462Vo> headerRowmapper = new RowMapper<Ope0462Vo>() {
		...
		public Ope0462Vo mapRow(ResultSet rs, int arg1) throws SQLException {
			...
			vo.setTaTaxReduceWsHdrId(rs.getString("TA_TAX_REDUCE_WS_HDR_ID"));
	...
	public List<LabelValueBean> findExciseId() {
		String sql = "SELECT DISTINCT EXCISE_ID FROM TA_TAX_REDUCE_WS_HDR";
