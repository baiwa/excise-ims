...
@Entity
@Table(name="OA_PRODUCT_REV_WS_HDR")
public class OaProductRevWsHdr extends BaseEntity {
	
	private static final long serialVersionUID = -4315013169318289392L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OA_PRODUCT_REV_WS_HDR_GEN")
	@SequenceGenerator(name = "OA_PRODUCT_REV_WS_HDR_GEN", sequenceName = "OA_PRODUCT_REV_WS_HDR_SEQ", allocationSize = 1)
