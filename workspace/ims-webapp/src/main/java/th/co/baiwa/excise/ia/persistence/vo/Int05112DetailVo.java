...
public class Int05112DetailVo {
	...
	public String getBookNumberWithdraw_Stamp() {
		return bookNumberWithdraw_Stamp;
	}

	public void setBookNumberWithdraw_Stamp(String bookNumberWithdraw_Stamp) {
		this.bookNumberWithdraw_Stamp = bookNumberWithdraw_Stamp;
	}
