...
public class Epa011Vo {
	...
	private String dateOutDisplay;
	private String dateInDisplay;
	...
	public String getDateOutDisplay() {
		return dateOutDisplay;
	}

	public void setDateOutDisplay(String dateOutDisplay) {
		this.dateOutDisplay = dateOutDisplay;
	}

	public String getDateInDisplay() {
		return dateInDisplay;
	}

	public void setDateInDisplay(String dateInDisplay) {
		this.dateInDisplay = dateInDisplay;
	}
