...
@Repository
public class AnalysisDataDetailDao {
	@Autowired
	private JdbcTemplate jdbcTemplate;
	
	private Logger logger = LoggerFactory.getLogger(AnalysisDataDetailDao.class);

	private final String sql = " SELECT * FROM TA_ANALYSIS_DATA_DETAIL ";
