...
public class ParameterGroup extends BaseEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SYS_PARAMETER_GROUP_GEN")
	@SequenceGenerator(name = "SYS_PARAMETER_GROUP_GEN", sequenceName = "SYS_PARAMETER_GROUP_SEQ", allocationSize = 1)
