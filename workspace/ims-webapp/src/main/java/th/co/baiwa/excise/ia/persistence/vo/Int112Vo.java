...
public class Int112Vo implements Serializable {
	
	private static final long serialVersionUID = 1918011693305830781L;
	
	private String followUpDepartmentId;
	private String exciseDepartment;
	private String exciseRegion;
	private String exciseDistrict;
	private String informRectorBnum;
	private String informRectorDate;
	private String followUp1Bnum;
	private String followUp1Date;
	private String maturity145;
	private String maturity160;
	private String performance1Bnum;
	private String performance1Date;
	private String trackResult1Bnum;
	private String trackResult1Date;
	private String followUp2Bnum;
	private String followUp2Date;
	private String maturity260;
	...
	private String followUp1DateDisplay;
	private String maturity145Display;
	private String maturity160Display;
	private String performance1DateDisplay;
	private String trackResult1DateDisplay;
	private String followUp2DateDisplay;
	...
	public String getFollowUpDepartmentId() {
		return followUpDepartmentId;
	}
	public void setFollowUpDepartmentId(String followUpDepartmentId) {
	...
	public String getInformRectorDate() {
		return informRectorDate;
	}
	public void setInformRectorDate(String informRectorDate) {
	...
	public String getFollowUp1Date() {
		return followUp1Date;
	}
	public void setFollowUp1Date(String followUp1Date) {
		this.followUp1Date = followUp1Date;
	}
	public String getMaturity145() {
		return maturity145;
	}
	public void setMaturity145(String maturity145) {
		this.maturity145 = maturity145;
	}
	public String getMaturity160() {
		return maturity160;
	}
	public void setMaturity160(String maturity160) {
	...
	public String getPerformance1Date() {
		return performance1Date;
	}
	public void setPerformance1Date(String performance1Date) {
	...
	public String getTrackResult1Date() {
		return trackResult1Date;
	}
	public void setTrackResult1Date(String trackResult1Date) {
	...
	public String getFollowUp2Date() {
		return followUp2Date;
	}
	public void setFollowUp2Date(String followUp2Date) {
		this.followUp2Date = followUp2Date;
	}
	public String getMaturity260() {
		return maturity260;
	}
	public void setMaturity260(String maturity260) {
	...
	public String getPerformance2Date() {
		return performance2Date;
	}
	public void setPerformance2Date(String performance2Date) {
	...
	public String getTrackResult2Date() {
	...
	public String getInformRectorDateDisplay() {
		return informRectorDateDisplay;
	}
	public void setInformRectorDateDisplay(String informRectorDateDisplay) {
		this.informRectorDateDisplay = informRectorDateDisplay;
	}
	public String getFollowUp1DateDisplay() {
		return followUp1DateDisplay;
	}
	public void setFollowUp1DateDisplay(String followUp1DateDisplay) {
		this.followUp1DateDisplay = followUp1DateDisplay;
	}
	public String getMaturity145Display() {
		return maturity145Display;
	}
	public void setMaturity145Display(String maturity145Display) {
		this.maturity145Display = maturity145Display;
	}
	public String getMaturity160Display() {
		return maturity160Display;
	}
	public void setMaturity160Display(String maturity160Display) {
		this.maturity160Display = maturity160Display;
	}
	public String getPerformance1DateDisplay() {
		return performance1DateDisplay;
	}
	public void setPerformance1DateDisplay(String performance1DateDisplay) {
		this.performance1DateDisplay = performance1DateDisplay;
	}
	public String getTrackResult1DateDisplay() {
		return trackResult1DateDisplay;
	}
	public void setTrackResult1DateDisplay(String trackResult1DateDisplay) {
		this.trackResult1DateDisplay = trackResult1DateDisplay;
	}
	public String getFollowUp2DateDisplay() {
		return followUp2DateDisplay;
	}
	public void setFollowUp2DateDisplay(String followUp2DateDisplay) {
		this.followUp2DateDisplay = followUp2DateDisplay;
	}
	public String getMaturity260Display() {
		return maturity260Display;
	}
	public void setMaturity260Display(String maturity260Display) {
		this.maturity260Display = maturity260Display;
	}
	public String getPerformance2DateDisplay() {
		return performance2DateDisplay;
	}
	public void setPerformance2DateDisplay(String performance2DateDisplay) {
		this.performance2DateDisplay = performance2DateDisplay;
	}
	public String getTrackResult2DateDisplay() {
		return trackResult2DateDisplay;
	}
