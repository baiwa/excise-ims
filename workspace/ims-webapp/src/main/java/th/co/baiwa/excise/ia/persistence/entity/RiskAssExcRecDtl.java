...
/**
 * The persistent class for the IA_RISK_ASS_EXC_REC_DTL database table.
 * 
 */
@Entity
@Table(name="IA_RISK_ASS_EXC_REC_DTL")
public class RiskAssExcRecDtl extends BaseEntity{
	

	private static final long serialVersionUID = -7161393509990089728L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IA_RISK_ASS_EXC_REC_DTL_GEN")
	@SequenceGenerator(name = "IA_RISK_ASS_EXC_REC_DTL_GEN", sequenceName = "IA_RISK_ASS_EXC_REC_DTL_SEQ", allocationSize = 1)
