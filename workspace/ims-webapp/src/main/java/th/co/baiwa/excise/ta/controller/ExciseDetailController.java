...
public class ExciseDetailController {
	...
	@ResponseBody
	public Response addFile(@PathVariable("num") String num, @PathVariable("id") String id,
			@RequestBody ExciseFile[] file) {
	...
	@PostMapping("/textFullAddressByExciseId")
	@ResponseBody
	public String textFullAddressByExciseId(@RequestBody PlanWorksheetVo planWorksheetVo) {
		return planWorksheetHeaderService.queryExciseIdFindByAddress(planWorksheetVo.getExciseId());
	}

	@PostMapping("/objectAddressByExciseId")
	@ResponseBody
	public CommonAddress objectAddressByExciseId(@RequestBody PlanWorksheetVo planWorksheetVo) {
		return planWorksheetHeaderService.splitAddress(planWorksheetVo.getExciseId());
	}
