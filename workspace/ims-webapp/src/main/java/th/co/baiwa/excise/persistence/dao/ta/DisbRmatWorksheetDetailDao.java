...
@Repository
public class DisbRmatWorksheetDetailDao {
	@Autowired
	private JdbcTemplate jdbcTemplate;
	
	private Logger logger = LoggerFactory.getLogger(DisbRmatWorksheetDetailDao.class);

	private final String sql = " SELECT * FROM TA_DISB_RMAT_WORKSHEET_DETAIL ";
