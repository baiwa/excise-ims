...
/**
 * The persistent class for the IA_RISK_ASS_EXC_OV3D_DTL database table.
 * 
 */
@Entity
@Table(name="IA_RISK_ASS_EXC_OV3D_DTL")
public class RiskAssExcOv3dDtl extends BaseEntity{


	private static final long serialVersionUID = 8610100576522683110L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IA_RISK_ASS_EXC_OV3D_DTL_GEN")
	@SequenceGenerator(name = "IA_RISK_ASS_EXC_OV3D_DTL_GEN", sequenceName = "IA_RISK_ASS_EXC_OV3D_DTL_SEQ", allocationSize = 1)
