...
export class UserManagementPage implements OnInit {
    ...
    initDatatable(): void {
        const URL = AjaxService.CONTEXT_PATH + "api/preferences/userManagement/search";
        this.userManagementDt = $('#userManagementDt').DataTable({
            ...
            "ajax": {
                ...
                "data": function (params) {
                    ...
                    params["accountNonExpired"] = $('#accountNonExpired').checkbox('is checked') ? "Y" : "";
                    params["credentialsNonExpired"] = $('#credentialsNonExpired').checkbox('is checked') ? "Y" : "";
                    params["accountNonLocked"] = $('#accountNonLocked').checkbox('is checked') ? "Y" : "";
                    return params;
                }
            },
            "columns": [
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return '<div class="ui checkbox tableDt"><input name="checkUserId" value="' + data + '" type="checkbox"><label></label></div>';
                    }
                },
                { "data": "username" },
                { "data": "enabled" },
