...
export class Cop0631Component implements OnInit, AfterViewInit {

  breadcrumb: BreadCrumb[] = [
    { label: "ตรวจปฏิบัติการ", route: "#" },
    { label: 'รายงานการตรวจปฏิบัติการ', route: '#' },
    { label: 'รายงานการตรวจปฏิบัติการจ่ายสินค้าสำเร็จรูป', route: '#' },
  ]
...
private authService: AuthService,
  ...
  ngOnInit() {
    this.authService.reRenderVersionProgram('COP-06301');
    $(".ui.dropdown").dropdown();
    $(".ui.dropdown.cop06-3-1").css("width", "100%");
