...
import { Cop0612Service } from 'projects/check-operation/cop06/cop06-12/cop06-12.service';
import { Cop0612Form } from 'projects/check-operation/cop06/cop06-12/cop06-12.modesl';
declare var $: any;
@Component({
  selector: 'cop06-12',
...
export class Cop0612Component implements OnInit {
  ...
  ngOnInit() {
    this.authService.reRenderVersionProgram('COP-06112');
    $("#Dtable").hide();
    this.findExciseId();
    this.callDropdown();
    this.calenda();
