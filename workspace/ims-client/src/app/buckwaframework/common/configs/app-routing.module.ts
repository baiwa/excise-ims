...
const routes: Routes = [
  ...
  {
    path: "login",
    loadChildren: "../../project/pages/login/login.module#LoginModule"
  },
  {
    path: "home",
    loadChildren: "../../project/pages/home/home.module#HomeModule"
  },
  {
    path: "message",
  ...
  {
    path: "cop01",
    loadChildren: "../../project/check-operation/cop01/cop01.module#Cop01Module"
  },
  {
    path: "cop02",
    loadChildren: "../../project/check-operation/cop02/cop02.module#Cop02Module"
  },
  {
    path: "cop03",
    loadChildren: "../../project/check-operation/cop03/cop03.module#Cop03Module"
  },
  {
    path: "cop04",
    loadChildren: "../../project/check-operation/cop04/cop04.module#Cop04Module"
  },
  {
    path: "cop05",
    loadChildren: "../../project/check-operation/cop05/cop05.module#Cop05Module"
  },
