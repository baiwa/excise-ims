...
import { ParameterInfo } from '../../common/models/parameterInfo';
...
export class ParameterInfoService {
    ...
    readonly url = 'api/preferences/parameterInfo';
    ...
    delete(parameterInfo: string):  Promise<ParameterInfo> {
        ...
        return this.http.delete(this.url+"/"+parameterInfo, {headers: this.headers})
          .toPromise()
          .then(() => null)
          .catch(this.handleError);
    }
    ...
    update(parameterInfo: ParameterInfo):  Promise<ParameterInfo> {
                ...
                return this.http.put(this.url, parameterInfo,{headers: this.headers})
                  .toPromise()
                  .then(() => null)
                  .catch(this.handleError);
    }
    ...
    read(parameterInfo: ParameterInfo):  Promise<ParameterInfo> {
                ...
                return this.http.get(this.url+"/"+parameterInfo.parameterInfoId, {headers: this.headers})
                  .toPromise()
                  .then((res) => JSON.parse(res['_body']).data as ParameterInfo)
